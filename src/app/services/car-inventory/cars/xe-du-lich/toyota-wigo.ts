  ...
  models: CarModelInfoInterface[] = [
    {
     ...
     },
     {
       ...
       promotion: [
        `Nhận ngay quà tặng trị giá 20 triệu đồng bao gồm: Bảo hành 5 năm/150.000 km,
        Ghế da & phim cách nhiệt chính hãng.
        Chương trình áp dụng từ 7/6 đến 31/12/2021`
       ],
       thongSo:[
        {label:"	Kích thước Kích thước tổng thể bên ngoài (D x R x C) (mm x mm x mm)		",value:"	3660 x 1600 x 1520	"},
        {label:"	Kích thước tổng thể bên trong (D x R x C) (mm x mm x mm)		",value:"	1940 x 1365 x 1235	"},
        {label:"	Chiều dài cơ sở (mm)		",value:"	2455	"},
        {label:"	Chiều rộng cơ sở (Trước / sau) (mm)		",value:"	1410 / 1405	"},
        {label:"	Khoảng sáng gầm xe (mm)		",value:"	160	"},
        {label:"	Góc thoát (Trước / Sau) (độ / degree)		",value:"	N / A	"},
        {label:"	Bán kính vòng quay tối thiểu (m)		",value:"	4,7	"},
        {label:"	Trọng lượng không tải (kg)		",value:"	870	"},
        {label:"	Trọng lượng toàn tải (kg)		",value:"	1290	"},
        {label:"	Dung tích bình nhiên liệu (L)		",value:"	33	"},
        {label:"	Dung tích khoang hành lý (L)		",value:"	N / A	"},
        {label:"	Động cơ xăng Loại động cơ		",value:"	3NR-VE	"},
        {label:"	Số xy lanh		",value:"	4	"},
        {label:"	Bố trí xy lanh		",value:"	Thẳng hàng / In line	"},
        {label:"	Dung tích xy lanh (cc)		",value:"	1197	"},
        {label:"	Hệ thống nhiên liệu		",value:"	Phun xăng điện tử / Electronic fuel injection	"},
        {label:"	Loại nhiên liệu		",value:"	Xăng / Petrol	"},
        {label:"	Công suất tối đa ((KW) HP / vòng / phút)		",value:"	(65)87 / 6000	"},
        {label:"	Mô men xoắn tối đa (Nm / vòng / phút)		",value:"	108 / 4200	"},
        {label:"	Hệ thống truyền động  		",value:"	Dẫn động cầu trước / FWD	"},
        {label:"	Hộp số  		",value:"	Số sàn 5 cấp / 5MT	"},
        {label:"	Hệ thống treo Trước		",value:"	Mc Pherson	"},
        {label:"	Sau		",value:"	Trục xoắn bán độc lập với lò xo cuộn / Semi Independent Torsion Axle Beam with Coil Spring	"},
        {label:"	Hệ thống lái Trợ lực tay lái		",value:"	Điện / Electric	"},
        {label:"	Vành & lốp xe Loại vành		",value:"	Hợp kim / Alloy	"},
        {label:"	Kích thước lốp		",value:"	175 / 65 R14	"},
        {label:"	Lốp dự phòng		",value:"	Vành thép / Steel	"},
        {label:"	Phanh Trước		",value:"	Phanh đĩa / Disc	"},
        {label:"	Sau		",value:"	Tang trống / Drum	"},
        {label:"	Tiêu chuẩn khí thải  		",value:"	Euro 4	"},
        {label:"	Tiêu thụ nhiên liệu Trong đô thị (L / 100km)		",value:"	6,8	"},
        {label:"	Ngoài đô thị (L / 100km)		",value:"	4,21	"},
        {label:"	Kết hợp (L / 100km)		",value:"	5,16	"},
        {label:"	Cụm đèn trước  		",value:"	Halogen	"},
        {label:"	Cụm đèn trước Đèn chiếu gần		",value:"	Dạng bóng chiếu / Projector	"},
        {label:"	Đèn chiếu xa		",value:"	Phản xạ đa chiều / Reflector	"},
        ...
        {label:"	Ăng ten  		",value:"	Dạng thường / Pillar	"},
        {label:"	Tay nắm cửa ngoài  		",value:"	Cùng màu thân xe / Body color	"},
        {label:"	Cánh hướng gió sau  		",value:"	Có / With	"},
        {label:"	Tay lái Loại tay lái		",value:"	3 chấu / 3-spoke	"},
        {label:"	Trợ lực		",value:"	Điện / EPS	"},
        {label:"	Chất liệu		",value:"	Nhựa / Urethane	"},
        {label:"	Nút bấm điều khiển tích hợp		",value:"	Hệ thống âm thanh / Audio system	"},
        {label:"	Điều chỉnh		",value:"	Không có / Without	"},
        {label:"	Gương chiếu hậu trong  		",value:"	2 chế độ ngày và đêm / Day & night	"},
        {label:"	Tay nắm cửa trong  		",value:"	Mạ bạc / Silver plating	"},
        {label:"	Cụm đồng hồ Loại đồng hồ		",value:"	Digital	"},
        ...
        {label:"	Nhắc nhở đèn bật		",value:"	Có / With	"},
        {label:"	Đèn cảnh báo thắt dây an toàn		",value:"	D only / Ghế lái	"},
        {label:"	Đèn cảnh báo cửa mở		",value:"	Có / With	"},
        {label:"	Chất liệu bọc ghế  		",value:"	Nỉ / Fabric	"},
        {label:"	Ghế trước Điều chỉnh ghế lái		",value:"	Chỉnh tay 4 hướng / 4 way manual	"},
        {label:"	Điều chỉnh ghế hành khách		",value:"	Chỉnh tay 4 hướng / 4 way manual	"},
        {label:"	Túi đựng đồ sau lưng ghế		",value:"	Có / With	"},
        {label:"	Ghế sau Hàng ghế thứ hai		",value:"	Gập hoàn toàn / United fold	"},
        {label:"	Hệ thống điều hòa  		",value:"	Manual with Max cool mode / Chỉnh tay với chế độ Max Cool	"},
        {label:"	Hệ thống âm thanh Đầu đĩa		",value:"	Màn hình cảm ứng 7inch	"},
        {label:"	Số loa		",value:"	4	"},
        {label:"	Cổng kết nối AUX		",value:"	Không / Without	"},
        {label:"	Cổng kết nối USB		",value:"	Có / With	"},
        {label:"	Kết nối Bluetooth		",value:"	Có / With	"},
        {label:"	Điều khiển giọng nói		",value:"	Không / Without	"},
        {label:"	Kết nối wifi		",value:"	Không / Without	"},
        {label:"	Kết nối điện thoại thông minh / Smartphone connectivity		",value:"	Không / Without	"},
        ...
        {label:"	Cửa sổ điều chỉnh điện  		",value:"	Có (tự động xuống bên lái) / With (D: auto down)	"},
        {label:"	Hệ thống báo động  		",value:"	Có / With	"},
        {label:"	Hệ thống mã hóa khóa động cơ  		",value:"	Có / With	"},
        {label:"	Hệ thống mở khóa cần số  		",value:"	Không có / Without	"},
        ...
        {label:"	Khóa cửa an toàn  		",value:"	Hàng ghế sau / Rear only	"},
        {label:"	Khóa an toàn trẻ em  		",value:"	ISO FIX	"}        
       ]
